...
<p align="center">
<img class="img-responsive" src="{{ site.baseurl }}/img/MZ_ECG.png" alt="Image Not Found" style="width:100%">
Fig. Configuration of leads which recoded ECG from 12 to 72 hours during daily life and a screenshot of the Mood Zoom app to record mood scores.
</p>
...
<p align="center">
<img class="img-responsive" src="{{ site.baseurl }}/img/MoodCorrelation.png" alt="Image Not Found" style="width:100%">
Fig. Correlations between changes in mood and changes in heart rate variability measures for bipolar disorder (BD), borderline personality disorder (BPD) and healthy control participants. Statistically significant correlations are shown as a solid line. mRR - mean R-R interval, HF - high frequency power (0.15-0.4Hz), LF - low frequency power (0.04-0.15Hz).
</p>
